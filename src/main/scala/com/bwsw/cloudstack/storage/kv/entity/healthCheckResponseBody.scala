...
sealed trait HealthCheckResponseBody
...
/** Contains detailed information about health checks performed to calculate total health status
  ...
  */
case class HealthCheckDetailedResponseBody(status: HealthStatus, checks: Seq[Check]) extends HealthCheckResponseBody

/** Contains short information about total health status
  *
  * @param status total health status
  */
case class HealthCheckShortResponseBody(status: HealthStatus) extends HealthCheckResponseBody
